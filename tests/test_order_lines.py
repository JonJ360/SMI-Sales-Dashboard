...
def test_frontend_exposes_accessible_lazy_detail_with_legacy_fallback():
    ...
    for token in ('VERSION 1.16', 'data-weekly-order', 'aria-expanded', 'toggleWeeklyOrder', 'renderWeeklyOrderLines', 'Line detail unavailable', 'Stock contribution', 'Source cost', 'No lines are removed', 'esc(line.description)', "esc(line.item||'No item ID')", 'weeklyOrders.onclick'):
